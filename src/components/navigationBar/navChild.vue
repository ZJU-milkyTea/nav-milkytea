        ...
        return{
            namelist:[ 
            {
                ...
                NavItem: [
                    ...
                    {nameNav: 'infoQ', jumpPath: 'https://www.infoq.cn/', picPath: require('@/assets/ima/wangyi_course.png')},
                    {nameNav: 'Cnode', jumpPath: 'https://cnodejs.org/', picPath: require('@/assets/ima/w3school.png')},
                    {nameNav: '掘金', jumpPath: 'https://juejin.cn/', picPath: require('@/assets/ima/MOOC.png')}
                ...
                NavItem: [
                    ...
                    {nameNav: '百度学术', jumpPath: 'https://xueshu.baidu.com/', picPath: require('@/assets/ima/text_compare.png')},
                    {nameNav: 'softonic', jumpPath: 'https://en.softonic.com/', picPath: require('@/assets/ima/qqMail.png')},
                    {nameNav: '荔枝数码', jumpPath: 'https://www.lizhi.io/', picPath: require('@/assets/ima/pdf_online.png')},
                    {nameNav: '中科大镜像', jumpPath: 'http://mirrors.ustc.edu.cn/', picPath: require('@/assets/ima/text_compare.png')},
                    {nameNav: 'Linux命令', jumpPath: 'https://man.linuxde.net/', picPath: require('@/assets/ima/qqMail.png')},
                    // {nameNav: '', jumpPath: '', picPath: require('@/assets/ima/.png')},
                    // {nameNav: '', jumpPath: '', picPath: require('@/assets/ima/.png')},
                    // {nameNav: '', jumpPath: '', picPath: require('@/assets/ima/.png')},
                    // {nameNav: '', jumpPath: '', picPath: require('@/assets/ima/.png')},
                ...
                NavItem: [
                    ...
                    {nameNav: 'Speedtest', jumpPath: 'https://www.speedtest.net/', picPath: require('@/assets/ima/baidufanyi.png')},
                    {nameNav: '域名比价', jumpPath: 'https://www.domcomp.com/', picPath: require('@/assets/ima/pdf_online.png')},
                ...
                NavItem: [
                    ...
                    {nameNav: '科大讯飞', jumpPath: 'https://iflytek.cheng95.com/other/campus', picPath: require('@/assets/ima/qqMail.png')},
                    // {nameNav: '', jumpPath: '', picPath: require('@/assets/ima/.png')},
                    // {nameNav: '', jumpPath: '', picPath: require('@/assets/ima/.png')},
                    // {nameNav: '', jumpPath: '', picPath: require('@/assets/ima/.png')},
                    // {nameNav: '', jumpPath: '', picPath: require('@/assets/ima/.png')},
            ...
            },
            {
                ...
                numberLink:5,
                NavItem: [
                    {nameNav: '淘宝', jumpPath: 'https://www.taobao.com/', picPath: require('@/assets/ima/baidufanyi.png')},
                    {nameNav: '京东', jumpPath: 'https://www.jd.com/', picPath: require('@/assets/ima/pdf_online.png')},
                    {nameNav: '亚马逊', jumpPath: 'https://www.amazon.cn/', picPath: require('@/assets/ima/text_compare.png')},
                    {nameNav: '苏宁易购', jumpPath: 'https://www.suning.com/', picPath: require('@/assets/ima/qqMail.png')},
                    {nameNav: '网易严选', jumpPath: 'https://you.163.com/', picPath: require('@/assets/ima/formatTrans.png')},
                    {nameNav: '小米商城', jumpPath: 'https://www.mi.com/', picPath: require('@/assets/ima/baidufanyi.png')},
                    {nameNav: '唯品会', jumpPath: 'https://www.vip.com/', picPath: require('@/assets/ima/pdf_online.png')},
                    {nameNav: '拼多多', jumpPath: 'https://youhui.pinduoduo.com/', picPath: require('@/assets/ima/text_compare.png')},
                    {nameNav: '飞猪旅行', jumpPath: 'https://weibo.com/', picPath: require('@/assets/ima/qqMail.png')},
